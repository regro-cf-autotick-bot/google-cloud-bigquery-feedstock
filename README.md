...
pixi add google-cloud-bigquery google-cloud-bigquery-core
# for installing globally
pixi global install google-cloud-bigquery google-cloud-bigquery-core
```
...
It is possible to list all of the versions of `google-cloud-bigquery` available on your platform:
...
```
pixi search google-cloud-bigquery --channel conda-forge
```
